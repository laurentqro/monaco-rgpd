...
ActiveRecord::Schema[8.1].define(version: 2025_11_12_085446) do
  ...
  create_table "action_items", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index [ "account_id", "priority" ], name: "index_action_items_on_account_id_and_priority"
    t.index [ "account_id", "status" ], name: "index_action_items_on_account_id_and_status"
    t.index [ "account_id" ], name: "index_action_items_on_account_id"
    t.index [ "actionable_type", "actionable_id" ], name: "index_action_items_on_actionable"
    t.index [ "actionable_type" ], name: "index_action_items_on_actionable_type"
  end
